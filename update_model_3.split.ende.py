    ...
    def __init__(self):
        ...
        with self.graph.as_default():
            ...
            with tf.variable_scope("encoder"):
                # Embedding
                # self.enc = embedding(self.user_api_all_eb,
                #                      vocab_size= USER_API_LEN*3,  #   len(de2idx), 200
                ...
                self.enc += positional_encoding(tf.tile(tf.expand_dims(tf.range(
                    tf.shape(self.user_api_all_eb)[1]),0),[tf.shape(self.user_api_all_eb)[0],1]),
                                          vocab_size = USER_API_LEN*3,
